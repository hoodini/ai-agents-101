            ...
            <div className="md:hidden border-t border-white/10 animate-fade-in">
              <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3">
                <nav className="flex flex-col gap-2">
                  ...
                  <button
                    onClick={() => { setShowWelcome(false); setShowResources(false); setShowAdvanced(false); setShowTechnical(true); setIsMobileMenuOpen(false); }}
                    className="text-left px-3 py-2 text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                  >
                    Technical
                  </button>
                  <button
                    onClick={() => { setShowWelcome(false); setShowResources(false); setShowAdvanced(true); setShowTechnical(false); setIsMobileMenuOpen(false); }}
                    className="text-left px-3 py-2 text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                  >
                    Advanced
                  </button>
        ...
        <header className="fixed top-0 left-0 right-0 z-50 glass-navbar border-b border-cyan-500/20">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-4 lg:gap-8 text-sm lg:text-base font-medium">
              ...
              <button className="text-blue-400 transition-colors font-semibold">
                Technical
              </button>
              <button
                onClick={() => {
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-white/10 animate-fade-in">
              <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3">
                <nav className="flex flex-col gap-2">
                  <button
                    onClick={() => { setShowWelcome(true); setShowResources(false); setShowAdvanced(false); setShowTechnical(false); setIsMobileMenuOpen(false); }}
                    className="text-left px-3 py-2 text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                  >
                    {t(language, 'home')}
                  </button>
                  ...
                  <button className="text-left px-3 py-2 text-blue-400 hover:bg-white/5 rounded-lg transition-colors font-semibold">
                    Technical
                  </button>
                  <button
                    onClick={() => { setShowWelcome(false); setShowResources(false); setShowAdvanced(true); setShowTechnical(false); setIsMobileMenuOpen(false); }}
